...
const Home = () => {
  ...
  const getRunTimes = async () => {
    ...
    console.log(options); // Log the options to check if Python is included
  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row items-center px-4 md:px-8 lg:px-16 xl:px-[100px] justify-between mt-5 gap-4">

        <h3 className='text-2xl text-white'>👋 hello {username} </h3>
      ...
      <div className="projects px-4 md:px-8 lg:px-16 xl:px-[100px] mt-5 pb-10">


        {
          projects && projects.length > 0 ? projects.map((project, index) => {
            return <>
              <div className="project w-full p-3 md:p-[15px] flex flex-col md:flex-row items-start md:items-center justify-between bg-[#0f0e0e] gap-3 md:gap-0">

                  <div onClick={() => { navigate("/editior/" + project._id) }} className='flex w-full flex-col md:flex-row items-start md:items-center gap-3 md:gap-[15px]'>
...

      {
        ...
        <div onClick={(e) => {
          if (e.target.classList.contains("modelCon")) {
            ...
            <div className="modelBox flex flex-col items-start rounded-xl p-[20px] w-[90vw] md:w-[25vw] h-[auto] bg-[#0F0E0E]">
